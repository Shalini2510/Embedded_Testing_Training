...
-- INSERT new records
INSERT INTO Categories (category_name) VALUES 
('Philosophy'), ('Technology'), ('Art');

INSERT INTO Books (title, isbn, publication_year, publisher, category_id) VALUES
('Meditations', '9780140449334', 1980, 'Penguin Classics', 6),
('The Art of Computer Programming', '9780201896831', 1968, 'Addison-Wesley', 7),
('The Story of Art', '9780714833552', 1950, 'Phaidon Press', 8);

INSERT INTO Authors (first_name, last_name) VALUES
('Marcus', 'Aurelius'), ('Donald', 'Knuth'), ('E.H.', 'Gombrich');

INSERT INTO BookAuthors (book_id, author_id) VALUES
(6, 6), (7, 7), (8, 8);

INSERT INTO Members (first_name, last_name, email, phone, address) VALUES
('Emily', 'Clark', 'emilyclark@example.com', '678-901-2345', '123 Elm Street'),
('Michael', 'Miller', 'michaelmiller@example.com', '789-012-3456', '456 Maple Avenue');

INSERT INTO Issue (book_id, member_id, Issue_date, due_date, return_date) VALUES
(6, 1, '2024-05-10', '2024-05-24', NULL),
(7, 2, '2024-05-11', '2024-05-25', NULL);

select * from  Books

-- UPDATE existing records
UPDATE Books SET publisher = 'Modern Classics' WHERE book_id = 1;

select * from Members
UPDATE Members SET email = 'john.doe@example.com' WHERE member_id = 1;
...
LINES TERMINATED BY '\n'
(title, isbn, publication_year, publisher, category_id);
